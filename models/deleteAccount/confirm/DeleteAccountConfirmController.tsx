...
import DeleteAccountConfirmView, {
  DeleteAccountConfirmViewProps,
} from './DeleteAccountConfirmView';
import { deleteAccountConfirmAPI } from '@/apis/deleteAccountConfirm';
import { useRouter } from 'next/router';
import { errorMessage } from '@/apis/errorMessage';

export interface DeleteAccountConfirmControllerProps {}

const DeleteAccountConfirmController =
  ({}: DeleteAccountConfirmControllerProps) => {
    ...
    const props: DeleteAccountConfirmViewProps = {};
